...
COVER_IMAGE_DIRECTORY = "/Volumes/Projects/Projects/aaronmoreycom_content/content/images/covers/"

data = []
importFile = "../data/goodreads_library_export.csv"
outputFile = "../data/goodreads.json"
